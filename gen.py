...
def generate_account(thread_id):
...
if __name__ == "__main__":
    ...
    num_accounts = int(input("Enter amount off kahoot accs too gen-> "))

    with ThreadPoolExecutor(max_workers=num_threads) as executor:
        futures = [executor.submit(generate_account, i) for i in range(num_accounts)]
